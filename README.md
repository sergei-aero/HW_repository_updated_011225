...
**Функция test_get_file_path**
- Тест формирования пути к файлу.

**Функция test_read_csv_file_success**
- Тест успешного чтения CSV файла.

**Функция test_read_excel_file_success**
- Тест успешного чтения Excel файла.

**Функция test_read_csv_file_not_found**
- Тест обработки отсутствующего файла.

**Функция test_read_empty_csv_file**
- Тест чтения пустого CSV файла.

**Функция test_read_csv_with_pandas_error**
